...
-- Dumping data for table store.categories: 8 rows
...
-- Dumping data for table store.customers: 91 rows
...
-- Dumping structure for table store.employees
...
-- Dumping data for table store.employees: 10 rows
...
-- Dumping data for table store.orders: 196 rows
...
-- Dumping structure for table store.order_details
...
-- Dumping data for table store.order_details: 518 rows
...
-- Dumping data for table store.products: 77 rows
...
-- Dumping structure for table store.shippers
...
-- Dumping data for table store.shippers: 3 rows
...
-- Dumping data for table store.suppliers: 29 rows
